...
KEEP_TURN_SQUARES = [BOARD_SQUARES_LOCATIONS[0][0], BOARD_SQUARES_LOCATIONS[2][0], BOARD_SQUARES_LOCATIONS[0][6], BOARD_SQUARES_LOCATIONS[2][6], BOARD_SQUARES_LOCATIONS[1][3]]

SAFE_SQUARE = BOARD_SQUARES_LOCATIONS[1][3]

# Player 1 mappings
P1_MAPPINGS = {'id' : "p1", 'color' : WHITE, 'cursor_color' : OFF_WHITE, 'move_seq' : PLAYER_ONE_SQUARES_SEQUENCE, 'score_center' : (640, 75), 'keys' : {'left' : K_a, 'right' : K_d, 'up' : K_w, 'down' : K_s}}

# Player 2 key mappings
P2_MAPPINGS = {'id' : "p2", 'color' : BLACK, 'cursor_color' : OFF_BLACK, 'move_seq' : PLAYER_TWO_SQUARES_SEQUENCE, 'score_center' : (780, 75), 'keys' : {'left' : K_a, 'right' : K_d, 'up' : K_w, 'down' : K_s}}
